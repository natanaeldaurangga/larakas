<div class="modal fade" id="form-utang" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Pencatatan utang</h5>
                ...
                <form action="/utang" class="form-create-utang" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="error-id_pemasok text-danger">

                            </div>
                            @include('modalOpsi.pemasok')
                        </div>
            ...
            $.ajax({
                ...
                error: function(xhr, ajaxOptions, thrownError) {
                    ...
                    if (response.errors) {
                        ...
                        if (response.errors.id_pemasok) {
                            $('#id_pemasok').addClass('is-invalid');
                            $('.error-id_pemasok').html(response.errors.id_pemasok);
                        } else {
                            $('#id_pemasok').removeClass('is-invalid');
                            $('.error-id_pemasok').html('');
                        }
                    }
